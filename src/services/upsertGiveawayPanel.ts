	...
	return {
		...
		components: [
			{ type: V2.TextDisplay, content: "## Управление розыгрышами" },
			{
				...
				content: [
					"Кнопки ниже:",
					"• **Создать розыгрыш** — откроет форму из 5 полей: приз, доп. параметры (картинка и ID роли), условия, количество победителей, время окончания.",
			...
			{ type: V2.Separator },
			{
				type: V2.TextDisplay,
				content: [
					"Если указан ID роли, розыгрыш пингует эту роль и участвовать могут только её владельцы.",
					"Если ID роли пустой, пинг остаётся через **@everyone**.",
					"",
					"**Поле доп. параметров:**",
					"• 1 строка — `https://...` для картинки",
					"• 2 строка — `123456789012345678` для ID роли",
					"",
